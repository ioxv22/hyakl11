...
export const SUBJECTS: Subject[] = [
  {
    ...
    color: "emerald",
    generalFiles: [
      { name: "هيكل الرياضيات للصف الحادي عشر متقدم 2026", type: "هيكل", path: "هيكل_الرياضيات_لصف_الحادي_عشر_متقدم_رفيل_فصل_الثال_260519_205502.pdf", views: 1845, dateAdded: "2026-05-18" },
      { name: "امتحان سابق 11 متقدم رياضيات", type: "امتحان", path: "امتحان سابق 11 متقدم.pdf", views: 982, dateAdded: "2026-05-20" },
      { name: "امتحان سابق رياضيات الفصل الثالث", type: "امتحان", path: "امتحان سابق الفصل 3.pdf", views: 1104, dateAdded: "2026-05-21" },
      { name: "ماث امتحان سابق وزارية", type: "امتحان", path: "ماث امتحان سابق.pdf", views: 765, dateAdded: "2026-05-22" },
      { name: "امتحان EOT G11 ADV", type: "امتحان", path: "EOT G11 ADV.pdf", views: 549, dateAdded: "2026-05-23" },
      { name: "G11 EOT T3 Word File 2026", type: "مراجعة", path: "G11 EOT T3 WORD FILE 2026.docx", views: 320, dateAdded: "2026-05-24" }
    ],
    chapters: [
      {
        id: "ch7",
        ...
        lessons: [
          {
            ...
            pdfFile: { name: "7.1 Introduction to Vectors مقدمة في المتجهات", type: "شرح", path: "7.1 Introduction to vectors مقدمة في المتجهات.pdf", views: 654, dateAdded: "2026-05-10" },
            ...
            formulas: [
              { title: "المركبة الأفقية للمتجه v", expression: "vx = |v| cos θ", explanation: "حيث |v| هو مقدار المتجه، و θ هي الزاوية التي يصنعها المتجه مع المحور الأفقي الموجب." },
              { title: "المركبة الرأسية للمتجه v", expression: "vy = |v| sin θ", explanation: "حيث |v| هو مقدار المتجه، و θ هي الزاوية مع المحور الأفقي الموجب." }
            ],
            vocabulary: [
              { word: "Vector", translation: "متجه", explanation: "كمية لها مقدار واتجاه." },
              { word: "Scalar", translation: "كمية قياسية", explanation: "كمية لها مقدار فقط مثل المسافة أو الزمن." },
              { word: "Resultant", translation: "المحصلة", explanation: "المتجه الناتج عن جمع متجهين أو أكثر." }
            ],
            importantQuestions: [
              { question: "كيف نوجد محصلة متجهين متعامدين؟", answer: "نستخدم نظرية فيثاغورس: R^2 = A^2 + B^2، ومنها R = √(A^2 + B^2)." },
              { question: "ما هو المتجه الصفري؟", answer: "هو متجه مقداره صفر وليس له اتجاه محدد، وينتج عن جمع متجهين متعاكسين متساويين في المقدار." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "7.2 Vectors in the coordinate plane", type: "شرح", path: "7_2_Vectors_in_the_coordinate_plane_المتجهات_في_المستوى_الإحداثي.pdf", views: 985, dateAdded: "2026-05-11" },
            extraFiles: [
              { name: "7.2 المتجهات في المستوى الإحداثي (نسخة إضافية)", type: "شرح", path: "7_2_Vectors_in_the_coordinate_plane_المتجهات_في_المستوى_الإحداثي (2).pdf", views: 420, dateAdded: "2026-05-11" }
            ],
            ...
            formulas: [
              { title: "الصورة المركبة للمتجه AB", expression: "⟨x2 - x1, y2 - y1⟩", explanation: "حيث A(x1, y1) هي نقطة البداية، و B(x2, y2) هي نقطة النهاية." },
              { title: "طول المتجه v = ⟨a, b⟩", expression: "|v| = √(a^2 + b^2)", explanation: "يمثل المسافة المستقيمة من بداية المتجه إلى نهايته." },
              { title: "متجه الوحدة u في اتجاه v", expression: "u = v / |v|", explanation: "هو متجه طوله 1 وله نفس اتجاه المتجه v." }
            ],
            vocabulary: [],
            importantQuestions: [
              { question: "كيف نوجد زاوية اتجاه متجه ⟨a, b⟩ مع المحور الأفقي الموجب؟", answer: "نستخدم العلاقة tan θ = b / a، ومنها θ = tan^-1(b/a). ويجب مراعاة الربع الذي يقع فيه المتجه لإضافة 180° أو 360° عند الضرورة." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "7.3 الضرب النقطي (محلول)", type: "مراجعة", path: "7.3 Dot product الضرب النقطي (محلول).pdf", views: 1205, dateAdded: "2026-05-12" },
            extraFiles: [
              { name: "7.3 الضرب النقطي (محلول) نسخة ثانية", type: "مراجعة", path: "7.3 Dot product الضرب النقطي (محلول) (2).pdf", views: 531, dateAdded: "2026-05-12" }
            ],
            ...
            formulas: [
              { title: "الضرب الداخلي لمتجهين u و v", expression: "u · v = u1·v1 + u2·v2", explanation: "حيث u = ⟨u1, u2⟩ و v = ⟨v1, v2⟩." },
              { title: "الزاوية بين متجهين u و v", expression: "cos θ = (u · v) / (|u| · |v|)", explanation: "حيث θ هي الزاوية الصغرى بين المتجهين، وتقع في الفترة [0, 180]." }
            ],
            vocabulary: [
              { word: "Dot Product", translation: "الضرب الداخلي / النقطي", explanation: "عملية ضرب متجهين ينتج عنها كمية قياسية." },
              { word: "Orthogonal Vectors", translation: "متجهات متعامدة", explanation: "متجهات الزاوية بينهما 90 درجة، وحاصل ضربهما الداخلي يساوي صفراً." }
            ],
            importantQuestions: [
              { question: "كيف نثبت إحداثياً أن متجهين متعامدان؟", answer: "نحسب u · v، فإذا كان الناتج يساوي 0، فإن المتجهين متعامدان." },
              { question: "ما معنى الشغل فيزيائياً وعلاقته بالضرب الداخلي؟", answer: "الشغل هو حاصل الضرب الداخلي لمتجه القوة في متجه الإزاحة: W = F · d = |F||d| cos θ." }
            ],
            mcq: [
              {
              ...
              },
              {
                ...
                options: ["⟨2, 3⟩ and ⟨-3, 2⟩", "⟨1, 2⟩ and ⟨2, 1⟩", "⟨3, -4⟩ and ⟨4, 3⟩", "Both A and C"],
                answerIndex: 3,
          ...
          },
          {
            ...
            pdfFile: { name: "7.4 المتجهات في الفضاء (غير محلول)", type: "شرح", path: "7_4_Vectors_in_3D_المتجهات_في_الفضاء_غير_محلول.pdf", views: 760, dateAdded: "2026-05-13" },
            extraFiles: [
              { name: "7.4 المتجهات في الفضاء (غير محلول) (2)", type: "شرح", path: "7_4_Vectors_in_3D_المتجهات_في_الفضاء_غير_محلول (2).pdf", views: 310, dateAdded: "2026-05-13" },
              { name: "7.4 المتجهات في الفضاء (محلول)", type: "شرح", path: "7_4_Vectors_in_3D_المتجهات_في_الفضاء_محلول.pdf", views: 980, dateAdded: "2026-05-13" }
            ],
            ...
            formulas: [
              { title: "المسافة بين نقطتين في الفضاء", expression: "d = √((x2-x1)^2 + (y2-y1)^2 + (z2-z1)^2)", explanation: "حساب البعد المستقيم بين نقطتين في المحاور الثلاثة." },
              { title: "طول المتجه v = ⟨a, b, c⟩", expression: "|v| = √(a^2 + b^2 + c^2)", explanation: "طول المتجه في الفضاء ثلاثي الأبعاد." }
            ],
            vocabulary: [
              { word: "Three-Dimensional Space", translation: "الفضاء ثلاثي الأبعاد", explanation: "نظام إحداثي يتكون من ثلاثة محاور متعامدة x, y, z." },
              { word: "Ordered Triple", translation: "ثلاثية مرتبة", explanation: "تمثيل النقطة في الفضاء كـ (x, y, z)." }
            ],
            importantQuestions: [
              { question: "أوجد نقطة منتصف القطعة المستقيمة بين (1, 4, -2) و (5, 0, 6)؟", answer: "نقطة المنتصف = ((x1+x2)/2, (y1+y2)/2, (z1+z2)/2) = ((1+5)/2, (4+0)/2, (-2+6)/2) = (3, 2, 2)." },
              { question: "كيف يكتب المتجه v = ⟨2, -3, 4⟩ كتركيب خطي لمتجهات الوحدة القياسية في الفضاء؟", answer: "يكتب على الصورة: 2i - 3j + 4k، حيث i, j, k هي متجهات الوحدة القياسية في اتجاه المحاور x, y, z على التوالي." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "7.5 الضرب المتجهي", type: "شرح", path: "7.5 Cross Product الضرب المتجهي.pdf", views: 924, dateAdded: "2026-05-14" },
            extraFiles: [
              { name: "7.5 الضرب المتجهي (2)", type: "شرح", path: "7.5 Cross Product الضرب المتجهي (2).pdf", views: 412, dateAdded: "2026-05-14" },
              { name: "7.5 الضرب المتجهي غير محلول", type: "شرح", path: "7_5_Cross_Product_الضرب_المتجهي_غير_محلول.pdf", views: 245, dateAdded: "2026-05-14" }
            ],
            ...
            formulas: [
              { title: "الضرب التقاطعي u x v", expression: "u x v = |i  j  k| \n        |u1 u2 u3| \n        |v1 v2 v3|", explanation: "يتم فك المحددة لإيجاد المركبات الثلاثة للمتجه الناتج." },
              { title: "مساحة متوازي الأضلاع المكون من u و v", expression: "Area = |u x v|", explanation: "تساوي طول متجه حاصل الضرب التقاطعي للمتجهين المتجاورين." },
              { title: "حجم متوازي السطوح", expression: "Volume = |t · (u x v)|", explanation: "يمثل القيمة المطلقة للمحدد المكون من مركبات المتجهات الثلاثة t, u, v." }
            ],
            vocabulary: [
              { word: "Cross Product", translation: "الضرب التقاطعي / الاتجاهي", explanation: "عملية ضرب متجهين في الفضاء ينتج عنها متجه عمودي عليهما." },
              { word: "Parallelepiped", translation: "متوازي السطوح", explanation: "مجسم ثلاثي الأبعاد كل وجه من وجوهه متوازي أضلاع." }
            ],
            importantQuestions: [
              { question: "ما النتيجة الهندسية للضرب u x w؟", answer: "هو متجه عمودي على المستوى الذي يحوي u و w، واتجاهه يحدد بقاعدة اليد اليمنى." },
              { question: "هل عملية الضرب التقاطعي تبديلية؟", answer: "لا، الضرب التقاطعي ليس تبديلياً، بل إن u x v = -(v x u)." }
            ],
            mcq: [
              {
        ...
        lessons: [
          {
            ...
            pdfFile: { name: "8.1 الاحداثيات القطبية", type: "شرح", path: "8.1 Polar coordinate الاحداثيات القطبية.pdf", views: 875, dateAdded: "2026-05-14" },
            extraFiles: [
              { name: "8.1 الاحداثيات القطبية غير محلول", type: "شرح", path: "8_1_Polar_coordinate_الاحداثيات_القطبية_غير_محلول.pdf", views: 345, dateAdded: "2026-05-14" }
            ],
            ...
            formulas: [
              { title: "تمثيل النقطة (r, θ) بزاوية بديلة", expression: "(r, θ + 2nπ)  أو  (-r, θ + (2n+1)π)", explanation: "للنقطة القطبية عدد لا نهائي من التمثيلات بسبب دورية الزاوية، وتغيير إشارة r يعكس الاتجاه بمقدار 180 درجة (π)." }
            ],
            vocabulary: [
              { word: "Pole", translation: "القطب", explanation: "نقطة الأصل في نظام الإحداثيات القطبية." },
              { word: "Polar Axis", translation: "المحور القطبي", explanation: "شعاع أفقي يمتد من القطب جهة اليمين، يشابه المحور x الموجب." }
            ],
            importantQuestions: [
              { question: "كيف نمثل النقطة (120° ,2-)؟", answer: "نتحرك بزاوية 120 درجة عكس عقارب الساعة، وبما أن r سالبة (-2)، نتحرك بالاتجاه المعاكس تماماً (امتداد الشعاع) بمسافة وحدتين، وهو ما يعادل تمثيل النقطة (300° ,2)." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "8.2 Graphs of Polar Equations (English)", type: "شرح", path: "8.2 Graphs of polar equations (English).pdf", views: 935, dateAdded: "2026-05-15" },
            ...
            formulas: [
              { title: "معادلة الدائرة القطبية مركزها القطب", expression: "r = a", explanation: "حيث a هو نصف قطر الدائرة." },
              { title: "معادلة الخط المستقيم القطبي المار بالقطب", expression: "θ = α", explanation: "حيث α هي الزاوية الثابتة التي يصنعها الخط مع المحور القطبي." }
            ],
            vocabulary: [
              { word: "Cardioid", translation: "المنحنى القلبي", explanation: "منحنى قطبي على شكل قلب، معادلته r = a(1 ± cos θ)." },
              { word: "Rose Curve", translation: "منحنى الوردة", explanation: "منحنى قطبي معادلته r = a cos(nθ) أو r = a sin(nθ). عدد بتلاته n إذا كان فردياً و 2n إذا كان n زوجياً." }
            ],
            importantQuestions: [
              { question: "ما عدد بتلات الوردة الممثلة بالمعادلة r = 4 sin(3θ)؟", answer: "بما أن معامل الزاوية n=3 (فردي)، فإن عدد البتلات يساوي n، أي 3 بتلات." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "8.3 الصور القطبية والديكارتية", type: "شرح", path: "8_3_Polar_and_Rectangular_Forms_الصور_القطبية_و_الديكارتية.pdf", views: 1045, dateAdded: "2026-05-16" },
            ...
            formulas: [
              { title: "التحويل من قطبي إلى ديكارتي", expression: "x = r cos θ  ,  y = r sin θ", explanation: "لإيجاد الإحداثيات الديكارتية مباشرة بمعرفة r و θ." },
              { title: "التحويل من ديكارتي إلى قطبي", expression: "r^2 = x^2 + y^2  ,  tan θ = y / x", explanation: "حيث r = √(x^2 + y^2) مع مراعاة الربع لتحديد θ بدقة." }
            ],
            vocabulary: [
              { word: "Rectangular Coordinates", translation: "الإحداثيات الديكارتية / المتعمدة", explanation: "تحديد النقطة ببعديها الأفقي x والرأسي y." }
            ],
            importantQuestions: [
              { question: "حول النقطة القطبية (4, π/6) إلى ديكارتية؟", answer: "الخطوات:\nx = 4 cos(π/6) = 4 (√3/2) = 2√3\ny = 4 sin(π/6) = 4 (1/2) = 2\nإذن الإحداثيات الديكارتية هي (2 ,2√3)." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "8.5 الأعداد المركبة ونظرية ديموافر", type: "شرح", path: "8_5_Complex_Numbers_and_DeMoivre s_Theorem_الاعداد_المركبة_و_نظر.pdf", views: 1198, dateAdded: "2026-05-17" },
            ...
            formulas: [
              { title: "الصورة القطبية للعدد المركب z", expression: "z = r(cos θ + i sin θ)", explanation: "حيث r = √(a^2 + b^2) هو المقياس (absolute value)، و θ = tan^-1(b/a) هي السعة (argument)." },
              { title: "ضرب عددين مركبين قطبياً", expression: "z1 · z2 = r1·r2 [cos(θ1 + θ2) + i sin(θ1 + θ2)]", explanation: "نضرب المقياسين ونجمع السعتين." },
              { title: "نظرية ديموافر (القوى)", expression: "z^n = r^n (cos nθ + i sin nθ)", explanation: "تسهل حساب القوى الكبيرة للأعداد المركبة." }
            ],
            vocabulary: [
              { word: "Modulus", translation: "المقياس", explanation: "طول العدد المركب في مستوى أرجاند، ويرمز له بـ r." },
              { word: "Argument", translation: "السعة", explanation: "الزاوية θ التي يصنعها العدد المركب مع المحور الحقيقي الموجب." }
            ],
            importantQuestions: [
              { question: "أوجد الجذور التكعيبية للواحد الصحيح؟", answer: "توزع الجذور بالتساوي على دائرة الوحدة بزوايا تفصل بينها 120 درجة، وهي: 1، و -1/2 + √3/2 i، و -1/2 - √3/2 i." }
            ],
            mcq: [
              {
        ...
        lessons: [
          {
            ...
            pdfFile: { name: "9.1 Sequences as functions المتتاليات كدوال", type: "شرح", path: "9.1 Sequences as functions المتتاليات كدوال.pdf", views: 643, dateAdded: "2026-05-17" },
            extraFiles: [
              { name: "9.1 المتتاليات كدوال غير محلول", type: "شرح", path: "9_1_Sequences_as_functions_المتتاليات_كدوال_غير_محلول.pdf", views: 231, dateAdded: "2026-05-17" }
            ],
          ...
          },
          {
            ...
            pdfFile: { name: "9.2 Sequences, Series, and Sigma Notation", type: "شرح", path: "9_2_Sequences,_Series,_and_Sigma_Notation_المتتاليات_و_المتسلسلا.pdf", views: 876, dateAdded: "2026-05-18" },
            extraFiles: [
              { name: "9.2 Sequences, Series, and Sigma Notation (2)", type: "شرح", path: "9_2_Sequences,_Series,_and_Sigma_Notation_المتتاليات_و_المتسلسلا (2).pdf", views: 421, dateAdded: "2026-05-18" }
            ],
            ...
            formulas: [
              { title: "رمز المجموع سيغما", expression: "∑ (from k=1 to n) a_k", explanation: "يعني جمع الحدود من الحد الأول a1 إلى الحد النوني an تعويضاً عن k." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "9.3 Arithmetic Sequences and Series", type: "شرح", path: "9_3_Arithmetic_Sequences_and_Series_المتتاليات_و_المتسلسلات_الحس.pdf", views: 981, dateAdded: "2026-05-19" },
            ...
            formulas: [
              { title: "الحد النوني لمتتالية حسابية", expression: "a_n = a_1 + (n - 1)d", explanation: "حيث a1 هو الحد الأول، و d هو الفرق المشترك." },
              { title: "مجموع متسلسلة حسابية منتهية", expression: "S_n = (n/2)(a_1 + a_n)  أو  S_n = (n/2)[2a_1 + (n-1)d]", explanation: "حيث Sn هو مجموع أول n من الحدود." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "9.4 Geometric Sequences and Series", type: "شرح", path: "9_4_Geometric_Sequences_and_Series_المتتاليات_و_المتسلسلات_الهند.pdf", views: 894, dateAdded: "2026-05-20" },
            ...
            formulas: [
              { title: "الحد النوني لمتتالية هندسية", expression: "a_n = a_1 · r^(n - 1)", explanation: "حيث r هو النسبة المشتركة (الأساس)." },
              { title: "مجموع متسلسلة هندسية منتهية", expression: "S_n = a_1(1 - r^n) / (1 - r)", explanation: "شرط ألا يكون r مساوياً للواحد الصحيح." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "9.5 Infinite Geometric Series", type: "شرح", path: "9_5_Infinite_Geometric_Series_المتسلسلات_الهندسية_اللانهائية.pdf", views: 978, dateAdded: "2026-05-21" },
            ...
            formulas: [
              { title: "مجموع متسلسلة هندسية لانهائية متقاربة", expression: "S = a_1 / (1 - r)", explanation: "يستخدم هذا القانون فقط عندما يكون |r| < 1 لجمع عدد لا نهائي من الحدود." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "9.6 Recursion and Iteration التكرار والإعادة", type: "شرح", path: "9.6 Recursion and Iteration التكرار والإعادة.pdf", views: 567, dateAdded: "2026-05-22" },
          ...
          },
          {
            ...
            videoIds: [],
            pdfFile: { name: "9.7 Binomial Theorem نظرية ذات الحدين", type: "شرح", path: "9.7 Binomial theorem  نظرية ذات الحدين.pdf", views: 902, dateAdded: "2026-05-23" },
            ...
            formulas: [
              { title: "مفكوك ذات الحدين (Binomial Theorem)", expression: "(x + y)^n = ∑ (from k=0 to n) nCk · x^(n-k) · y^k", explanation: "حيث nCk تمثل التوافيق وتساوي n! / (k!(n-k)!)." },
              { title: "صيغة الحد رقم (r + 1)", expression: "T_{r+1} = nCr · x^(n-r) · y^r", explanation: "تستخدم لإيجاد حد معين مباشرة." }
            ],
            mcq: [
              {
  ...
  },
  {
    ...
    color: "amber",
    generalFiles: [
      { name: "ملزمة مراجعة الفيزياء للصف الحادي عشر متقدم أول", type: "مراجعة", path: "صف ١١ متقدم أول ملزمة مراجعة (1).pdf", views: 1202, dateAdded: "2026-05-15" }
    ],
    chapters: [
      {
        ...
        lessons: [
          {
            ...
            pdfFile: { name: "Physics Made Easy Rotational Motion", type: "شرح", path: "Rotational motion.pdf", views: 890, dateAdded: "2026-05-02" },
            extraFiles: [
              { name: "Rotational motion ,,,,,", type: "مراجعة", path: "Rotational motion ,,,,,.pdf", views: 1354, dateAdded: "2026-05-03" },
              { name: "Rotational Motion (1- Describing Rotational Motion)", type: "شرح", path: "Rotational Motion (1- Describing Rotational Motion ).pdf", views: 421, dateAdded: "2026-05-04" },
              { name: "Rotational Motion 26", type: "مراجعة", path: "Rotational Motion 26.pdf", views: 562, dateAdded: "2026-05-05" }
            ],
            summary: "",
            mcq: [
              {
        ...
        lessons: [
          {
            ...
            pdfFile: { name: "Rotational Dynamics", type: "شرح", path: "Rotational dynamics.pdf", views: 651, dateAdded: "2026-05-12" },
            extraFiles: [
              { name: "Part 1 Rotational Dynamics", type: "شرح", path: "Part 1Rotational Dynamics.pdf", views: 321, dateAdded: "2026-05-12" }
            ],
            summary: "",
            mcq: [
              {
        ...
        lessons: [
          {
            ...
            videoIds: ["wV7jP1R2p8o"],
            pdfFile: { name: "MOMENTUM", type: "شرح", path: "MOMENTUM.pdf", views: 1104, dateAdded: "2026-05-14" },
            summary: "",
            mcq: [
              {
        ...
        lessons: [
          {
            ...
            pdfFile: { name: "1-Impulse and Momentum (part 1 )", type: "شرح", path: "1-Impulse and Momentum (part 1 ).pdf", views: 765, dateAdded: "2026-05-15" },
            extraFiles: [
              { name: "1-Impulse and Momentum (part 2 )", type: "شرح", path: "1-Impulse and Momentum (part 2 ).pdf", views: 320, dateAdded: "2026-05-15" }
            ],
            summary: "",
            mcq: [
              {
        ...
        lessons: [
          {
            ...
            videoIds: ["dQw4w9WgXcQ"],
            pdfFile: { name: "Module 16 Reflection and Refraction 10adv", type: "شرح", path: "Module 16 Reflection and Refraction 10adv.pdf", views: 887, dateAdded: "2026-05-16" },
            summary: "",
            mcq: [
              {
        ...
        lessons: [
          {
            ...
            videoIds: ["wV7jP1R2p8o"],
            pdfFile: { name: "Equilibrium Sec3 2026 11ADV SOLVED", type: "شرح", path: "Equilibrium Sec3 2026 11ADV SOLVED.pdf", views: 987, dateAdded: "2026-05-18" },
            summary: "",
            mcq: [
              {
  ...
  },
  {
    ...
    color: "blue",
    generalFiles: [
      { name: "هيكل التربية الإسلامية للفصل الدراسي الثالث 2026", type: "هيكل", path: "هيكل_اختبار_الصف_الحادي_عشر_الفصل_الدراسي_الثالث_2025_2026م.pdf", views: 1654, dateAdded: "2026-05-18" },
      { name: "ملخص أحكام التجويد للصف الحادي عشر", type: "مراجعة", path: "ملخص أحكام التجويد.pdf", views: 1876, dateAdded: "2026-05-19" },
      { name: "تجميعات التربية الإسلامية 1_2_merged", type: "مراجعة", path: "1_2_merged.pdf", views: 980, dateAdded: "2026-05-20" },
      { name: "تجميعة أسئلة إسلامية 1686833401", type: "مراجعة", path: "1686833401.pdf", views: 421, dateAdded: "2026-05-21" },
      { name: "تجميعة أسئلة إسلامية 1748948954", type: "مراجعة", path: "1748948954.pdf", views: 320, dateAdded: "2026-05-22" }
    ],
    chapters: [
      {
        id: "lessons",
        ...
        lessons: [
          {
            ...
            pdfFile: { name: "درس 35: سورة الأحزاب", type: "شرح", path: "_٣٥_رسول_الله_صلى_الله_عليه_وسلم_وخاتم_النبيين_سورة_الأحزاب_.pdf", views: 954, dateAdded: "2026-05-02" },
            summary: "",
            mcq: [
              {
                ...
                options: ["إلغاء التبني والتأكيد على ختم النبوة", "التشجيع على التبني", "إيجاب الهجرة إلى المدينة", "إثبات بنوة زيد للرسول"],
                answerIndex: 0,
          ...
          },
          {
            ...
            pdfFile: { name: "درس 36: أحكام وآداب بيت النبوة", type: "شرح", path: "_٣٦_أحكام_وآداب_بيت_النبوة_سورة_الأحزاب.pdf", views: 874, dateAdded: "2026-05-03" },
            summary: "",
            mcq: [
              {
                question: "تسمى زوجات النبي صلى الله عليه وسلم بـ:",
                options: ["أمهات المؤمنين", "بنات الرسول", "حاضنات الرسالة", "سيدات مكة"],
                answerIndex: 0,
          ...
          },
          {
            ...
            pdfFile: { name: "درس 37: الإنصاف في الإسلام", type: "شرح", path: "٣٧.  الإنصاف في الإسلام.pdf", views: 762, dateAdded: "2026-05-04" },
            summary: "",
            mcq: [
              {
                question: "معنى الإنصاف في الإسلام هو:",
                options: ["العدل وإعطاء كل ذي حق حقه دون محاباة", "التغاضي عن الأخطاء دائماً", "الانحياز للأقارب فقط", "مساواة الصالح بالفاسد"],
                answerIndex: 0,
          ...
          },
          {
            ...
            videoIds: ["-w9BxuSZK98"],
            pdfFile: { name: "درس: المحرمات من النساء", type: "شرح", path: "41. المحرمات من النساء.pdf", views: 541, dateAdded: "2026-05-10" },
            summary: "",
            mcq: [
              {
                question: "من المحرمات حرمة مؤبدة بسبب النسب:",
                options: ["الأم والأخت والبنت", "زوجة الأخ", "أخت الزوجة", "المرأة المعتدة"],
                answerIndex: 0,
          ...
          },
          {
            ...
            pdfFile: { name: "درس 39: الأمن المائي والغذائي والتنمية المستدامة", type: "شرح", path: "الأمن المائي والغذائي والتنمية المستدامة — الإمارات.pdf", views: 1324, dateAdded: "2026-05-05" },
            extraFiles: [
              { name: "درس 39: من معالم رحمة الرسول", type: "شرح", path: "_٣٩_من_معالم_رحمة_الرسول_صلى_الله_عليه_وسلم.pdf", views: 980, dateAdded: "2026-05-05" }
            ],
            summary: "",
            mcq: [
              {
                question: "ما حكم إهدار المياه والإسراف فيها في الإسلام؟",
                options: ["محرم ومنهي عنه شرعاً", "مكروه فقط", "مباح للجميع", "مستحب عند الوفرة"],
                answerIndex: 0,
          ...
          },
          {
            ...
            pdfFile: { name: "درس 41: ضوابط اجتماعية سورة الأحزاب", type: "شرح", path: "_٤١_ضوابط_اجتماعية_سورة_الأحزاب_.pdf", views: 651, dateAdded: "2026-05-06" },
            summary: "",
            mcq: [
              {
                question: "حاربت سورة الأحزاب الشائعات في المجتمع، وتوعدت الذين يرجفون في المدينة بـ:",
                options: ["الطرد والنفي واللعن إن لم ينتهوا", "الغرامة المالية", "السجن المؤبد", "التجاهل التام"],
                answerIndex: 0,
          ...
          },
          {
            ...
            pdfFile: { name: "درس 42: الإنسان والأمانة سورة الأحزاب", type: "شرح", path: "_٤٢_الإنسان_والأمانة_سورة_الأحزاب.pdf", views: 987, dateAdded: "2026-05-07" },
            summary: "",
            mcq: [
              {
                question: "ما هي الأمانة التي حملها الإنسان وأشفقت منها السماوات والأرض والجبال؟",
                options: ["التكليف وحرية الاختيار والمسؤولية", "الكنوز والذهب", "عمارة الأرض بالطوب", "السفر عبر الفضاء"],
                answerIndex: 0,
  ...
  },
  {
    ...
    color: "teal",
    generalFiles: [
      { name: "هيكل الأحياء الرسمي للفصل الثالث 2026", type: "هيكل", path: "EoT3_Coverage_G11_ADV_Bio_INS_T3_ 2025-2026.pdf", views: 2451, dateAdded: "2026-05-19" },
      { name: "أحياء مراجعة شاملة وأسئلة سنوات سابقة", type: "مراجعة", path: "احياء_مراجعة_شاملة_اسيلة_سنوات_سابقة_ف_3_احياء.pdf", views: 1541, dateAdded: "2026-05-20" },
      { name: "أسئلة وزارية متميزة - وحدة المناعة", type: "مراجعة", path: "اسيلة وزارية وحدة المناعة.pdf", views: 874, dateAdded: "2026-05-21" }
    ],
    chapters: [
      {
        id: "bio_term3",
        ...
        lessons: [
          {
            ...
            pdfFile: { name: "Infectious Diseases Booklet", type: "شرح", path: "Infectious Diseases.pdf", views: 654, dateAdded: "2026-05-02" },
            extraFiles: [
              { name: "Infectious Diseases Booklet (2)", type: "شرح", path: "Infectious Diseases (2).pdf", views: 211, dateAdded: "2026-05-02" },
              { name: "Infectious Diseases Booklet (3)", type: "شرح", path: "Infectious Diseases (3).pdf", views: 198, dateAdded: "2026-05-02" }
            ],
            ...
            vocabulary: [
              { word: "Pathogen", translation: "مسبب المرض", explanation: "كائن مجهري مثل الفيروس أو البكتيريا يسبب المرض للعائل." }
            ],
            mcq: [
              {
          ...
          },
          {
            ...
            pdfFile: { name: "The Immune System Booklet", type: "شرح", path: "The immune system.pdf", views: 876, dateAdded: "2026-05-03" },
            extraFiles: [
              { name: "The Immune System Booklet (2)", type: "شرح", path: "The Immune System (2).pdf", views: 321, dateAdded: "2026-05-03" }
            ],
          ...
          },
          {
            ...
            pdfFile: { name: "Noninfectious Diseases Booklet", type: "شرح", path: "Noninfectious Diseases.pdf", views: 541, dateAdded: "2026-05-04" },
            extraFiles: [
              { name: "Noninfectious disorders Booklet (2)", type: "شرح", path: "Noninfectious disorders (2).pdf", views: 187, dateAdded: "2026-05-04" }
            ],
  ...
  },
  {
    ...
    color: "pink",
    generalFiles: [
      { name: "السيناريو الثاني في الكيمياء - كتيب المراجعة الشامل 11ADV", type: "مراجعة", path: "General Revision 11ADV_Scenario2.pdf", views: 1845, dateAdded: "2026-05-18" },
      { name: "امتحان كيمياء هيكل الوزارة EOT-CHE-1-T3-26", type: "امتحان", path: "EOT-CHE-1-T3-26_MOE.pdf", views: 1412, dateAdded: "2026-05-19" },
      { name: "ملخص تفاعلات الأكسدة والاختزال كيمياء 12-11 متقدم", type: "مراجعة", path: "Redox Reactions- 12 Adv.- Mr. Hesham Eltoukhy.pdf", views: 980, dateAdded: "2026-05-20" },
      { name: "امتحان تدريبي كيمياء Q2 Practice 1", type: "امتحان", path: "practice Q2  (1).pdf", views: 654, dateAdded: "2026-05-21" },
      { name: "كتيب كيمياء Scenario 2 Booklet الأصلي", type: "هيكل", path: "document (39).pdf", views: 1105, dateAdded: "2026-05-22" }
    ],
    chapters: [
      {
        id: "chem_term3",
        ...
        lessons: [
          {
            ...
            pdfFile: { name: "السيناريو الثاني كيمياء - كتيب المراجعة الشامل", type: "مراجعة", path: "General Revision 11ADV_Scenario2.pdf", views: 985, dateAdded: "2026-05-02" },
            ...
            formulas: [
              { title: "قانون ثابت الاتزان Keq", expression: "Keq = [C]^c [D]^d / [A]^a [B]^b", explanation: "للتفاعل المتزن: aA + bB ⇌ cC + dD. تشتمل فقط على المواد الغازية والمحاليل المائية." }
            ],
            mcq: [
              {
            ...
            mcq: [
              {
                ...
                options: ["أسلوب تعجب", "أسلوب استفهام", "أسلوب نداء", "أسلوب أمر"],
                answerIndex: 0,
              ...
              },
              {
                ...
                options: ["فاعل مرفوع بالضمة", "مبتدأ مرفوع بالضمة", "خبر مرفوع بالضمة", "مفعول به منصوب بالفتحة"],
                answerIndex: 0,
              ...
              },
              {
                ...
                options: ["الحال يبين هيئة صاحبه والتمييز يبين المبهم من ذات أو نسبة", "لا فرق بينهما", "الحال يأتي مجروراً دائماً", "التمييز يأتي جملة فعلية"],
                answerIndex: 0,
